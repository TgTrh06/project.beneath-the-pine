...
import { formatFocusTime, useFocusTimer } from "../features/focus/focusTimer";
...
const initialHabits: Habit[] = [{ id: "water", title: "Uống một cốc nước", completed: false }, { id: "desk", title: "Dọn một góc nhỏ", completed: false }];
